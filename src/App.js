...
function App() {
  ...
  return (
    <div ref={(element) => {refs.current["outerScreen"] = element}} style={{minWidth:"100vw", maxWidth:"100vw", maxHeight:"100vh", minHeight:"100vh", margin:"0", padding:"0", color:"white", fontWeight:"bold"}}>
      ...
      <div style={{zIndex:9, transformOrigin:"right bottom", transform:"scale("+100/zoom+")", position:"fixed", right:"0", bottom:"0", display:"flex", flexDirection:"row", justifyContent:"space-evenly", alignItems:"center", margin:"4px 0px 4px 0px", padding:"0px 4px", borderRadius:"0px", minWidth:"120px", fontSize:"small"}}>TreeMinder v1.0.4</div>
    </div>
  )
}
